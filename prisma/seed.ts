...
async function main() {
  ...
  // STRONG STUDENT OUTPUT - Alice Johnson (formerly Liam Wong)
  ...
  // WEAK STUDENT OUTPUT - Bob Williams (formerly Alex Carter)
  ...
  // INTERMEDIATE STUDENT OUTPUT - Charlie Brown (formerly Maya Singh)
